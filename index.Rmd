...
A tentative snakemake workflow that defines **read quality control rules** in a DAG (directed acyclic graph) format. 
A detailed interactive snakemake report is available [here](https://complexdatainsights.com/imap/imap-read-quality-control/report.html).
